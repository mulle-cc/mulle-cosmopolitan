#ifndef demo_objc_version_h__
#define demo_objc_version_h__
...
static inline unsigned int   demo_objc_get_version_major( void)
{
   return( DEMO_OBJC_VERSION >> 20);
}


static inline unsigned int   demo_objc_get_version_minor( void)
{
   return( (DEMO_OBJC_VERSION >> 8) & 0xFFF);
}


static inline unsigned int   demo_objc_get_version_patch( void)
{
